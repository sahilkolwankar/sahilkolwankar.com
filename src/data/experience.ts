...
export const experience: ExperienceEntry[] = [
  {
    ...
    bullets: [
      ...
      'After a Redis consumer stall silently dropped thousands of Treasury Prime webhooks, root-caused the failure, reconciled conflicting stream-retention caps, and in the process found and removed plaintext SSNs, signature images, and home addresses sitting unused on an event stream - a three-line change that cut stream storage by half and closed a real data-exposure path.',
